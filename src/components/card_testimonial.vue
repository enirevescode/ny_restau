...
const temoignages = [
       ...
       "alt": "portrait",
       "name": "Emma Odinson",
       "avis": "Rhoncus risus donec neque egestas ultrices ullamcorper cursus aliquam nunc. Cras est sit libero, est in scelerisque donec. Tincidunt malesuada odio neque et vel fringilla elit. Placerat turpis mus donec id vel"
          },
          {
       "id": 2,
       "img": "src/assets/diana.webp",
       "alt": "portrait",
       "name":"Diana Annakin",
       "avis": "Rhoncus risus donec neque egestas ultrices ullamcorper cursus aliquam nunc. Cras est sit libero, est in scelerisque donec. Tincidunt malesuada odio neque et vel fringilla elit. Placerat turpis mus donec id vel"
          },
